...
//    }
    ...
    @Before("PointCutSample.getPointCut() || PointCutSample.setPointCut()")
    public void doSomeBeforeGetAndSet(){
        System.out.println("this is before get() or set advise!...");
    }
}
